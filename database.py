...
def init_db():
    ...
    # Bill table columns safety check
    _add_column_if_missing(cursor, "bills", "customer_name", "TEXT")
    _add_column_if_missing(cursor, "bills", "subtotal", "REAL")
    _add_column_if_missing(cursor, "bills", "tax_percentage", "REAL")
    _add_column_if_missing(cursor, "bills", "tax_amount", "REAL")
    _add_column_if_missing(cursor, "bills", "grand_total", "REAL")
    _add_column_if_missing(cursor, "bills", "payment_mode", "TEXT")
    _add_column_if_missing(cursor, "bills", "created_at", "TEXT")
